...
## For additional datasets such as Mip-NeRF 360, please refer to the ns-process-data toolkit for data conversion and preprocessing instructions.
    ...
    def __init__(self, split, tag, **kwargs):
        ...
        if split != 'val':
            if kwargs.pop('if_bin_render', False):
                _, pipeline, _ = eval_setup(self.model_path / 'config_bin.yml')
            else:
